        ...
        <?php else : ?> 
            ...
            <ul class="Social-links">
                <li><a href="<?php
                    ...
                    ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/facebook.png" /><?php _e('&nbsp;&nbsp;Join Us On Facebook', 'black-bird'); ?></a></li>
                <li><a href="<?php
                    ...
                    ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/twitter.png" /><?php _e('&nbsp;&nbsp;Join Us On Twitter', 'black-bird'); ?></a></li>
                <li><a href="<?php
                    ...
                    ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/linkdin.png" /><?php _e('&nbsp;&nbsp;Join Us On In.com', 'black-bird'); ?></a></li>
                <li><a href="<?php
                    ...
                    ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/subscribe.png" /><?php _e('&nbsp;&nbsp;Subscribe to Our Blog', 'black-bird'); ?></a></li>
            </ul>
        <?php endif; ?>
    </div>
</div>

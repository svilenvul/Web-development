...
namespace EntityFramework_Homework
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int usp_findTotalIncome(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_findTotalIncome", supplierNameParameter, startDateParameter, endDateParameter);
        }
    }
}
